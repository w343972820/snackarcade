...
This policy explains what information SnackArcade collects when you visit, why it is collected, and what you can do about it. It is written to be read, not to be skimmed past.
...
**Analytics.** If site analytics are enabled, they run in aggregate and IP-anonymised mode. They tell us that a page received a certain number of visits; they do not tell us who you are.

**Information stored on your own device.** Games save your progress, best scores and settings in your browser's `localStorage`. This data never leaves your device and is not readable by us. Clearing your browser data deletes it permanently.
...
When advertising is active on this site, Google is one of the third-party vendors serving ads.

- Google uses cookies, including the **DoubleClick DART cookie**, to serve ads based on your prior visits to this and other websites.
- Google's use of advertising cookies enables it and its partners to serve ads to you based on your visit to SnackArcade and other sites on the internet.
- You can opt out of personalised advertising by visiting **[Google Ads Settings](https://www.google.com/settings/ads)**.
- You can opt out of third-party vendor cookies more broadly at **[aboutads.info/choices](https://www.aboutads.info/choices/)** and **[youronlinechoices.eu](https://www.youronlinechoices.eu/)**.
- Google's own policy is at **[policies.google.com/technologies/ads](https://policies.google.com/technologies/ads)**.

Third-party vendors and ad networks other than Google may also serve ads on this site and may set their own cookies. We do not control those cookies and cannot read them.
...
Server logs are retained for a short operational period and then discarded. Contact emails are kept only while the matter is open. The site is served entirely over HTTPS.

## External links

Game pages link to the original developers' repositories and licences, and some games are served from partner platforms. Once you follow a link off this site, this policy no longer applies — the destination site's own policy does.
